...
const SectionSlider = memo(
  ({
    ...
    const addCustomClassToVisibleSlides = useCallback((swiper) => {
      if (slider.current) {
        if (swiper) {
          slider.current
    ...
    const memoizedBreakpoints = useMemo(
      ...
      [slideSmall, slideMedium, slidesPerView]
    );
      ...
      <div className={className}>
        <Container fluid>
          ...
          >
            ...
            >
              {list.map((data, index) => (
                <SwiperSlide tag="li" key={data._id}>
